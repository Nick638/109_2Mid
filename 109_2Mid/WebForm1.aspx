...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label4" runat="server" Text="其他連結"></asp:Label><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl ="https://aws.amazon.com/tw">aws</asp:HyperLink> <br/>
